...
namespace publiclib.Cache.Redis.Service
{
    ...
    public class RedisSetService : RedisHelper
    {
        ...
        public RedisSetService(int? dbNum = null) : base(dbNum) { }

        public RedisSetService(int? dbNum, string redisHostAddress) : base(dbNum, redisHostAddress) { }
        #endregion
        ...
        public string SetPop(string key)
        {
            key = AddSysCustomKey(key);
            var rValue = base.redis.SetPop(key);
            return Convert.ToString(rValue);
        }
