...
namespace publiclib.Cache.Redis
{
    ...
    internal class RedisManager
    {
        ...
        //        {
        //            string json = Utils.PostUrl(ConfigurationManager.AppSettings["ConnectionStrings"], "");
        ...
        ///// </summary>
        //internal static readonly string RedisSysCustomKey = "Park"; //WebConfigurationManager.AppSettings["RedisSysCustomKey"];

        ///// <summary>
        ///// 当前连接的Redis中的DataBase索引，默认0-16，可以在service.conf配置，最高64
        ///// </summary>
        //internal static readonly int RedisDataBaseIndex = int.Parse(ConnectionStrings["RedisDataBaseIndex"]);

        ///// <summary>
        ///// 当前连接的Redis中连接字符串，格式为：127.0.0.1:6379,allowadmin=true,password=pwd
        ///// </summary>
        //internal static readonly string RedisHostConnection = ConnectionStrings["RedisHostConnection"];
        ...
        {
            //Log.Error($"Redis 发生错误: {e.Message}");
        }
        ...
        private static void MuxerInternalError(object sender, InternalErrorEventArgs e)
        {
            ...
            //Log.Error($"Redis 类库错误: {e.Exception.Message}");
        }
